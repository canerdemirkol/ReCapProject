...
namespace WebAPI
{
    ...
    public class Startup : BusinessStartup
    {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                option.AddPolicy("AllowOrgin", builder => builder.WithOrigins("http://localhost:3000"));//react uygulaması default yayın portu
                option.AddPolicy("AllowOrgin", builder => builder.WithOrigins("http://localhost:4200"));//angular uygulaması default yayın portu
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCors(builder => builder
                      ...
                      .AllowAnyHeader()
                      .AllowAnyMethod()
                      .AllowAnyHeader());//bu adresten gelen bütün isteklere izin ver 
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("v1/swagger.json", "ReCap API V1");
            });
